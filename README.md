# cloud-itonami-iso3166-swe

Open ISO 3166 Blueprint for **SWE**: Sweden.
...
tax registration, and EU single-market rules in Sweden, so the operator
...
- **Not the government of Sweden.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Swedish-licensed counsel
...
(ISO 3166 `SWE`). Required capabilities:
