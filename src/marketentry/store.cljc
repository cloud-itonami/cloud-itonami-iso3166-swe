(ns marketentry.store
  "SSoT for the SWE market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems SE" :portal "e-Avrop/TendSign"
             ...
             :requires-orgnr? true :orgnr-verified? true
             :drafted? false :submitted? false
             :jurisdiction "SWE" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "e-Avrop/TendSign"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-orgnr? true :orgnr-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "e-Avrop/TendSign"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "SWE" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "e-Avrop/TendSign"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "SWE" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "e-Avrop/TendSign"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-orgnr? true :orgnr-verified? false
             :drafted? false :submitted? false
             :jurisdiction "SWE" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "e-Avrop/TendSign"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-orgnr?)    (assoc :engagement/requires-orgnr? requires-orgnr?)
    (some? orgnr-verified?)    (assoc :engagement/orgnr-verified? orgnr-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-orgnr? :engagement/orgnr-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-orgnr? (boolean (:engagement/requires-orgnr? m))
     :orgnr-verified? (boolean (:engagement/orgnr-verified? m))
